-- xmonad config based heavily on http://github.com/vicfryzel/xmonad-config
...
-- preset keybindings.
myLauncher = "$(~/.cabal/bin/yeganesh -x -- -nb '#000000' -nf '#FFFFFF' -sb '#7C7C7C' -sf '#CEFFAC')"
...
--
myWorkspaces = ["1:ide","2:term","3:web","4:comm","5:media"] ++ map show [6..9]
